  ...
  <div class="min-h-screen bg-gradient-to-b from-slate-50 via-orange-50/20 to-white">
    ...
    <div class="relative h-40 bg-gradient-to-r from-orange-600 via-orange-500 to-amber-500 overflow-hidden">
      <div class="absolute inset-0">
        ...
        <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-orange-400/20 rounded-full blur-3xl"></div>
      </div>
      <div class="relative h-full flex items-center justify-center">
        <div class="text-center">
          <div class="flex items-center justify-center gap-3 mb-3">
            ...
            <h1 class="text-3xl font-bold text-white drop-shadow-lg">加密货币快讯</h1>
          </div>
    ...
    <div class="max-w-7xl mx-auto px-4 py-8">
      <!-- 加载骨架屏 -->
      <div v-if="loading && newsList.length === 0" class="grid grid-cols-1 lg:grid-cols-3 gap-6">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-6" v-else>
        ...
        <div class="lg:col-span-2 space-y-5">
          ...
          <div class="flex items-center justify-between mb-6">
            ...
            <div class="flex items-center gap-3">
              <span class="text-sm text-gray-500">共 {{ newsList.length }} 篇</span>
